...
static void MakeChange(int cost, int[] cashTill, int twenties, int tens = 0, int fives = 0, int ones = 0)
{
    ...
    int[] availableDenominations = new int[4]; 

    availableDenominations[0] = cashTill[3] + twenties; 
    availableDenominations[1] = cashTill[2] + tens;
    availableDenominations[2] = cashTill[1] + fives;
    availableDenominations[3] = cashTill[0] + ones; 
    ...
    {
        while (changeNeeded >= denominations[i] && availableDenominations[i] > 0)
        {
    ...
    cashTill[0] = availableDenominations[3];
    cashTill[1] = availableDenominations[2]; 
    cashTill[2] = availableDenominations[1]; 
    cashTill[3] = availableDenominations[0]; 
}
